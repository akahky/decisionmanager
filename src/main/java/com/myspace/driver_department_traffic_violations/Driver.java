...
public class Driver implements java.io.Serializable {
	...
	private java.util.List<com.myspace.driver_department_traffic_violations.Violation> violations;
	...
	public java.util.List<com.myspace.driver_department_traffic_violations.Violation> getViolations() {
		return this.violations;
	}

	public void setViolations(
			java.util.List<com.myspace.driver_department_traffic_violations.Violation> violations) {
